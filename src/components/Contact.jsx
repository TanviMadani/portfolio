    ...
    <div id="contact" className="py-16 bg-background">
      <div className="container mx-auto px-4 md:pl-24 md:pr-16">
        ...
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Contact Information */}
          <div className="p-6 rounded-lg shadow-lg bg-card border-theme" data-aos="fade-right" style={{ border: '1px solid var(--border)' }}>
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p>tanvimadani88888@google.com</p>
                </div>
              </div>
            ...
            <div className="mt-8">
              ...
              <div className="flex space-x-4">
                <a href="#" className="text-accent hover-primary transition-colors">
          ...
          {/* Contact Form */}
          <div className="bg-card p-6 rounded-lg shadow-lg border-theme" data-aos="fade-left" style={{ border: '1px solid var(--border)' }}>
            ...
            <form>
              <div className="mb-4">
                ...
                <input 
                  type="text" 
                  id="name" 
                  className="w-full bg-background border border-theme rounded py-2 px-3 focus:outline-none focus:border-primary"
